...
import { X, User, Mail, Phone, MapPin, Building, Camera, Save } from 'lucide-react';
...
export const ProfilePage: React.FC<ProfilePageProps> = ({ onClose }) => {
  const [formData, setFormData] = useState({
    ...
    company: 'Allo Béton SARL',
    position: 'Gestionnaire Principal',
    bio: 'Responsable de la gestion des ventes et du stock de béton.'
  });
      ...
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900">{formData.firstName} {formData.lastName}</h3>
