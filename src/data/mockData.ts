...
export const products: Product[] = [
  ...
  },
  {
    ...
    minStock: 5,
    unit: 'm³',
    description: 'Béton renforcé de fibres pour sols industriels'
  },
  {
    id: '4',
    name: 'Adjuvant Plastifiant',
    type: 'additive',
    category: 'Additifs',
    price: 15000,
    stock: 100,
    minStock: 20,
    unit: 'L',
    description: 'Améliore la plasticité du béton'
  },
  {
    id: '5',
    ...
    minStock: 15,
    unit: 'kg',
    description: 'Accélère le durcissement du béton'
  }
];
